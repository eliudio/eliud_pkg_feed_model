...
//        final values = state.values;
            ...
            ((false) == true)
                ? Container(
                    ...
                    child: dropdownButton<String>(
                      ...
                      items: items,
                      value: value,
                      hint: text(widget.app, context, 'Select a post'),
            ...
            if (value != null)
              Align(
                  ...
                  child: button(
                    ...
                    label: 'Update',
                    onPressed: () {
                      updateComponent(context, widget.app, 'posts', value,
                          (newValue, _) {
                        setState(() {
                          value = value;
                        });
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<PostListBloc>(context).add(PostChangeQuery(
