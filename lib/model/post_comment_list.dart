...
typedef PostCommentWidgetProvider = Function(PostCommentModel? value);

class PostCommentListWidget extends StatefulWidget with HasFab {
  final AppModel app;
  final BackgroundModel? listBackground;
  final PostCommentWidgetProvider? widgetProvider;
  final bool? readOnly;
  final String? form;
  //final PostCommentListWidgetState? state;
  ...
  PostCommentListWidgetState createState() {
    return PostCommentListWidgetState();
  }

  @override
  Widget? fab(BuildContext context) {
    if ((readOnly != null) && readOnly!) return null;
    var state = PostCommentListWidgetState();
    return state.fab(
      context,
    );
  }
