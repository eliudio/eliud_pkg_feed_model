...
typedef FeedFrontChanged = Function(
  String? value,
  int? privilegeLevel,
);
...
class _FeedFrontDropdownButtonWidgetState
  ...
  void didChangeDependencies() {
    bloc = BlocProvider.of<FeedFrontListBloc>(context);
...
//        final values = state.values;
            ...
            ((false) == true)
                ? Container(
                    ...
                    child: dropdownButton<String>(
                      ...
                      items: items,
                      value: value,
                      hint: text(widget.app, context, 'Select a feedFront'),
            ...
            if (value != null)
              Align(
                  ...
                  child: button(
                    ...
                    label: 'Update',
                    onPressed: () {
                      updateComponent(context, widget.app, 'feedFronts', value,
                          (newValue, _) {
                        setState(() {
                          value = value;
                        });
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<FeedFrontListBloc>(context).add(FeedFrontChangeQuery(
