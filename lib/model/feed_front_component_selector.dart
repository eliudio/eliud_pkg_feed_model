...
import 'feed_front_list_bloc.dart';
import 'feed_front_list_event.dart';
...
class FeedFrontComponentSelector extends ComponentSelector {
  ...
  Widget createSelectWidget(BuildContext context, AppModel app,
    ...
    return BlocProvider<FeedFrontListBloc>(
...
class _SelectFeedFrontWidgetState extends State<_SelectFeedFrontWidget>
  ...
  Widget theList(BuildContext context, List<FeedFrontModel?> values) {
    var app = widget.app;
