...
typedef FeedFrontWidgetProvider = Function(FeedFrontModel? value);

class FeedFrontListWidget extends StatefulWidget with HasFab {
  final AppModel app;
  final BackgroundModel? listBackground;
  final FeedFrontWidgetProvider? widgetProvider;
  final bool? readOnly;
  final String? form;
  //final FeedFrontListWidgetState? state;
  ...
  FeedFrontListWidgetState createState() {
    return FeedFrontListWidgetState();
  }

  @override
  Widget? fab(BuildContext context) {
    if ((readOnly != null) && readOnly!) return null;
    var state = FeedFrontListWidgetState();
    return state.fab(
      context,
    );
  }
