...
typedef ProfileChanged = Function(
  String? value,
  int? privilegeLevel,
);
...
class _ProfileDropdownButtonWidgetState
  ...
  void didChangeDependencies() {
    bloc = BlocProvider.of<ProfileListBloc>(context);
...
//        final values = state.values;
            ...
            ((false) == true)
                ? Container(
                    ...
                    child: dropdownButton<String>(
                      ...
                      items: items,
                      value: value,
                      hint: text(widget.app, context, 'Select a profile'),
            ...
            if (value != null)
              Align(
                  ...
                  child: button(
                    ...
                    label: 'Update',
                    onPressed: () {
                      updateComponent(context, widget.app, 'profiles', value,
                          (newValue, _) {
                        setState(() {
                          value = value;
                        });
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<ProfileListBloc>(context).add(ProfileChangeQuery(
