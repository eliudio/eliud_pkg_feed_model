...
//        final values = state.values;
          ...
          Row(children: [
            ((false) == true)
                ? Container(
                    ...
                    child: dropdownButton<String>(
                      ...
                      hint: text(widget.app, context,
                          'Select a labelledBodyComponent'),
                ...
                : dropdownButton<String>(
                    ...
                    value: value,
                    hint: text(
                        widget.app, context, 'Select a labelledBodyComponent'),
                    onChanged: _onValueChange,
                  ),
            ...
            if (value != null)
              Align(
                  ...
                  child: button(
                    ...
                    onPressed: () {
                      updateComponent(
                          context, widget.app, 'labelledBodyComponents', value,
                          (newValue, _) {
                        setState(() {
                          value = value;
                        });
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<LabelledBodyComponentListBloc>(context)
        .add(LabelledBodyComponentChangeQuery(
